...
export function LosRemansos() {
  return (
    <Card sx={{ maxWidth: 500 }}>
      ...
      />
      <CardContent>
        <Typography gutterBottom variant="h5" component="div" color="#534340">
      ...
      <CardActions>
        <Button target={'_blank'} 
          ...
          size="small" style={{ color: '#C5D8A4' }} >Cómo Llegar</Button>
      </CardActions>
    ...
    <Card sx={{ maxWidth: 500 }}>
      ...
      <CardActions>
        <Button target={'_blank'} href="https://www.nonoturismo.gob.ar"
          style={{ color: '#C5D8A4' }} size="small">Sitio Web</Button>
    ...
    <Card sx={{ maxWidth: 500 }}>
      ...
      <CardActions>
        <Button target={'_blank'} href="https://www.museorocsen.org"
          size="small" style={{ color: '#C5D8A4' }} >Sitio Web</Button>
